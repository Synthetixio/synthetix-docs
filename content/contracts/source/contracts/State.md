...
**Source:** [contracts/State.sol](https://github.com/Synthetixio/synthetix/tree/v2.27.2-beta/contracts/State.sol)
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-beta/contracts/State.sol#L11)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-beta/contracts/State.sol#L13)</sub>
...
??? example "Details"
    ...
    * [require(..., Owner must be set)](https://github.com/Synthetixio/synthetix/tree/v2.27.2-beta/contracts/State.sol#L15)
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-beta/contracts/State.sol#L24)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-beta/contracts/State.sol#L31)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-beta/contracts/State.sol#L38)</sub>
