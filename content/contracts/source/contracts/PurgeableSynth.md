...
**Source:** [contracts/PurgeableSynth.sol](https://github.com/Synthetixio/synthetix/tree/v2.27.2-alpha/contracts/PurgeableSynth.sol)
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-alpha/contracts/PurgeableSynth.sol#L18)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-alpha/contracts/PurgeableSynth.sol#L24)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-alpha/contracts/PurgeableSynth.sol#L45)</sub>
...
??? example "Details"
    ...
    * [require(..., Cannot purge as total supply is above threshold and rate is not frozen.)](https://github.com/Synthetixio/synthetix/tree/v2.27.2-alpha/contracts/PurgeableSynth.sol#L51)
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-alpha/contracts/PurgeableSynth.sol#L72)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-alpha/contracts/PurgeableSynth.sol#L39)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.27.2-alpha/contracts/PurgeableSynth.sol#L69)</sub>
