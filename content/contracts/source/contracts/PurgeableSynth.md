...
**Source:** [contracts/PurgeableSynth.sol](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol)
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol#L18)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol#L24)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol#L36)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol#L49)</sub>
...
??? example "Details"
    ...
    * [require(..., Cannot purge as total supply is above threshold and rate is not frozen.)](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol#L55)
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol#L76)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol#L43)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.36.0-alpha/contracts/PurgeableSynth.sol#L73)</sub>
