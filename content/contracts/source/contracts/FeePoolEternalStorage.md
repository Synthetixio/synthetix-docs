...
**Source:** [contracts/FeePoolEternalStorage.sol](https://github.com/Synthetixio/synthetix/tree/v2.62.0-alpha/contracts/FeePoolEternalStorage.sol)

## Constructor

### `constructor`

<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.62.0-alpha/contracts/FeePoolEternalStorage.sol#L11)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.62.0-alpha/contracts/FeePoolEternalStorage.sol#L13)</sub>
...
??? example "Details"
    ...
    * [require(..., "Length mismatch")](https://github.com/Synthetixio/synthetix/tree/v2.62.0-alpha/contracts/FeePoolEternalStorage.sol#L18)
