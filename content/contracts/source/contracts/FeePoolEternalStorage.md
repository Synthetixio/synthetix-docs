...
**Source:** [contracts/FeePoolEternalStorage.sol](https://github.com/Synthetixio/synthetix/tree/v2.31.0-alpha/contracts/FeePoolEternalStorage.sol)
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.31.0-alpha/contracts/FeePoolEternalStorage.sol#L12)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.31.0-alpha/contracts/FeePoolEternalStorage.sol#L14)</sub>
...
??? example "Details"
    ...
    * [require(..., Length mismatch)](https://github.com/Synthetixio/synthetix/tree/v2.31.0-alpha/contracts/FeePoolEternalStorage.sol#L19)
