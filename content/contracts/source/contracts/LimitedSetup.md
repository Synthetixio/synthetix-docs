...
**Source:** [contracts/LimitedSetup.sol](https://github.com/Synthetixio/synthetix/tree/v2.69.0-alpha/contracts/LimitedSetup.sol)

## Variables

### `setupExpiryTime`

<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.69.0-alpha/contracts/LimitedSetup.sol#L5)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.69.0-alpha/contracts/LimitedSetup.sol#L11)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.69.0-alpha/contracts/LimitedSetup.sol#L15)</sub>
