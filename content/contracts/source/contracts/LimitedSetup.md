...
**Source:** [contracts/LimitedSetup.sol](https://github.com/Synthetixio/synthetix/tree/v2.24.0-alpha/contracts/LimitedSetup.sol)

## Variables

### `setupExpiryTime`

<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.24.0-alpha/contracts/LimitedSetup.sol#L6)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.24.0-alpha/contracts/LimitedSetup.sol#L12)</sub>
...
<sub>[Source](https://github.com/Synthetixio/synthetix/tree/v2.24.0-alpha/contracts/LimitedSetup.sol#L16)</sub>
